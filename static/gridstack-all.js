 ...
 * Original file: /npm/gridstack@12.6.0/dist/gridstack-all.js
 *
...
!(function (e, t) {
  ...
  (() => {
    ...
    class i {
      static getElements(e, t = document) {
        if ("string" == typeof e) {
          ...
          if (
            ...
            const i = t.querySelector(`[gs-id="${e}"]`);
            return i ? [i] : [];
          }
          return Array.from(s);
        }
      ...
      static lazyLoad(e) {
        return e.lazyLoad || (e.grid?.opts?.lazyLoad && !1 !== e.lazyLoad);
      }
      ...
      static getScrollElement(e) {
        ...
        return ("auto" === t || "scroll" === t) &&
          ...
          ? e
          : i.getScrollElement(e.parentElement);
      }
      static updateScrollResize(e, t, s) {
        const o = i.getScrollElement(t),
          n = o.clientHeight,
          r = o === i.getScrollElement() ? 0 : o.getBoundingClientRect().top,
          a = e.clientY - r,
          h = a > n - s;
        a < s
          ? o.scrollBy({ behavior: "smooth", top: a - s })
          : h && o.scrollBy({ behavior: "smooth", top: s - (n - a) });
      }
      static clone(e) {
      ...
      static appendTo(e, t) {
        let s;
        ((s = "string" == typeof t ? i.getElement(t) : t),
          s && s.appendChild(e));
      }
    ...
    class s {
      constructor(e = {}) {
        ((this.addedNodes = []),
          ...
          (this.column = e.column || this.defaultColumn),
      ...
      _fixCollisions(e, t = e, s, o = {}) {
        ...
        for (; (s = s || this.collide(e, n, o.skip)); ) {
          ...
          if (
            ...
            const h = { ...t, y: s.y + s.h, ...a };
            ((n = !(!this._loading || !i.samePos(e, h)) || this.moveNode(e, h)),
              ...
              (r = r || n));
          } else n = this.moveNode(s, { ...s, y: t.y + t.h, skip: e, ...a });
          if (!n) return r;
          s = void 0;
        }
        return r;
      ...
      directionCollideCoverage(e, t, i) {
        ...
        const s = e._rect,
          o = { ...t.rect };
        let n;
        (o.y > s.y ? ((o.h += o.y - s.y), (o.y = s.y)) : (o.h += s.y - o.y),
          o.x > s.x ? ((o.w += o.x - s.x), (o.x = s.x)) : (o.w += s.x - o.x));
        let r = 0.5;
        for (let e of i) {
          ...
          (s.y < t.y
            ? (i = (o.y + o.h - t.y) / t.h)
            : s.y + s.h > t.y + t.h && (i = (t.y + t.h - o.y) / t.h),
            s.x < t.x
              ? (a = (o.x + o.w - t.x) / t.w)
              : s.x + s.w > t.x + t.w && (a = (t.x + t.w - o.x) / t.w));
          const h = Math.min(a, i);
          h > r && ((r = h), (n = e));
        }
      ...
      isAreaEmpty(e, t, i, s) {
        const o = { x: e || 0, y: t || 0, w: i || 1, h: s || 1 };
      ...
      prepareNode(e, t) {
        ...
        if (o) {
          let t = 1;
          for (; this.nodes.find((t) => t.id === e.id && t !== e); )
            e.id = o + "_" + t++;
        }
        ...
        return (
          ...
          isNaN(e.x) && ((e.x = n.x), (e.autoPosition = !0)),
          isNaN(e.y) && ((e.y = n.y), (e.autoPosition = !0)),
          isNaN(e.w) && (e.w = n.w),
          isNaN(e.h) && (e.h = n.h),
      ...
      nodeBoundFix(e, t) {
        const s = e._orig || i.copyPos({}, e);
        if (
          (e.maxW && (e.w = Math.min(e.w || 1, e.maxW)),
          e.maxH && (e.h = Math.min(e.h || 1, e.maxH)),
          e.minW && (e.w = Math.max(e.w || 1, e.minW)),
          e.minH && (e.h = Math.max(e.h || 1, e.minH)),
          (e.x || 0) + (e.w || 1) > this.column &&
            this.column < this.defaultColumn &&
            !this._inColumnResize &&
            !this.skipCacheUpdate &&
            null != e._id &&
            -1 === this.findCacheLayout(e, this.defaultColumn))
        ) {
          const t = { ...e };
          (t.autoPosition || void 0 === t.x
            ? (delete t.x, delete t.y)
            : (t.x = Math.min(this.defaultColumn - 1, t.x)),
            (t.w = Math.min(this.defaultColumn, t.w || 1)),
            this.cacheOneLayout(t, this.defaultColumn));
        }
        return (
      ...
      restoreInitial() {
        return (
          this.nodes.forEach((e) => {
            e._orig &&
              !i.samePos(e, e._orig) &&
              (i.copyPos(e, e._orig), (e._dirty = !0));
          }),
          this._notify(),
          this
        );
      ...
      findEmptyPosition(e, t = this.nodes, s = this.column, o) {
        ...
        for (let r = o ? o.y * s + (o.x + o.w) : 0; !n; ++r) {
          const o = r % s,
            a = Math.floor(r / s);
          if (o + e.w > s) continue;
          const h = { x: o, y: a, w: e.w, h: e.h };
          t.find((e) => i.isIntercepted(h, e)) ||
            ((e.x === o && e.y === a) || (e._dirty = !0),
            (e.x = o),
            (e.y = a),
      ...
      addNode(e, t = !1, i) {
        const s = this.nodes.find((t) => t._id === e._id);
        if (s) return s;
        let o;
        return (
          ...
          e.autoPosition &&
            ...
            (delete e.autoPosition, (o = !0)),
          this.nodes.push(e),
          t && this.addedNodes.push(e),
          o || this._fixCollisions(e),
      ...
      moveNodeCheck(e, t) {
        ...
        if (!r && !t.resizing && t.collide) {
          const i = t.collide.el.gridstackNode;
        ...
        return (
          ...
          (n.nodes
            .filter((e) => e._dirty)
            .forEach((e) => {
              const t = this.nodes.find((t) => t._id === e._id);
      ...
      moveNode(e, t) {
        ...
        if (
          ...
          return !1;
        const r = i.copyPos({}, e),
          a = this.collideAll(e, n, t.skip);
        let h = !0;
        if (a.length) {
          const o = e._moving && !t.nested;
          let r = o ? this.directionCollideCoverage(e, t, a) : a[0];
          if (o && r && e.grid?.opts?.subGridDynamic && !e.grid._isTemp) {
            const s = i.areaIntercept(t.rect, r._rect),
              o = i.area(t.rect),
              n = i.area(r._rect);
            s / (o < n ? o : n) > 0.8 &&
        ...
        return (
          h && !i.samePos(e, n) && ((e._dirty = !0), i.copyPos(e, n)),
      ...
      endUpdate() {
        const e = this.nodes.find((e) => e._updating);
        return (e && (delete e._updating, delete e._skipDown), this);
      }
      save(e = !0, t, s) {
        const o = this._layouts?.length || 0;
        let n;
        o &&
          (s
            ? s !== this.column && (n = this._layouts[s])
            : this.column !== o - 1 && (n = this._layouts[o - 1]));
        const r = [];
        return (
          this.sortNodes(),
          this.nodes.forEach((s) => {
            const o = n?.find((e) => e._id === s._id),
              a = { ...s, ...(o || {}) };
            (i.removeInternalForSave(a, !e), t && t(s, a), r.push(a));
          }),
          r
        );
      }
              ...
              if (i < this.column) this._layouts[i] = void 0;
                ...
                e.forEach((e) => {
                  ...
                  i &&
                    (i.y >= 0 &&
                      e.y !== e._orig.y &&
                      ((i.y += e.y - e._orig.y), i.y < 0 && (i.y = 0)),
                    e.x !== e._orig.x &&
                      ((i.x = Math.round(e.x * s)), i.x < 0 && (i.x = 0)),
                    e.w !== e._orig.w &&
                      ((i.w = Math.round(e.w * s)), i.w < 1 && (i.w = 1)));
                });
              }
            }),
          this
      ...
      columnChanged(e, t, s = "moveScale") {
        ...
        if (t > e && this._layouts) {
          const i = this._layouts[t] || [],
            s = this._layouts.length - 1;
          (!i.length &&
            e !== s &&
            this._layouts[s]?.length &&
            ((e = s),
            this._layouts[s].forEach((e) => {
              const t = r.find((t) => t._id === e._id);
              t &&
                (o ||
                  e.autoPosition ||
            ...
            i.forEach((e) => {
              const t = r.findIndex((t) => t._id === e._id);
              if (-1 !== t) {
                const i = r[t];
        ...
        if (o) this.compact(s, !1);
          ...
          if (r.length)
            if ("function" == typeof s) s(t, e, n, r);
              ...
              const i = o || "none" === s ? 1 : t / e,
                a = "move" === s || "moveScale" === s,
                h = "scale" === s || "moveScale" === s;
              (r.forEach((s) => {
                ((s.x =
                  1 === t ? 0 : a ? Math.round(s.x * i) : Math.min(s.x, t - 1)),
                  (s.w =
                    1 === t || 1 === e
                      ? 1
                      : h
      ...
      cacheOneLayout(e, t) {
        ...
        const o = this.findCacheLayout(e, t);
        return (
          -1 === o ? this._layouts[t].push(i) : (this._layouts[t][o] = i),
          this
        );
      }
      findCacheLayout(e, t) {
      ...
      cleanupNode(e) {
        for (const t in e) "_" === t[0] && "_id" !== t && delete e[t];
        return this;
      }
    }
    s._idSeq = 0;
    ...
    function h(e, t) {
      e.touches.length > 1 ||
        ...
        i.simulateMouseEvent(e.changedTouches[0], t));
    }
    function l(e, t) {
      (e.cancelable && e.preventDefault(), i.simulateMouseEvent(e, t));
    }
    function d(e) {
      a.touchHandled || ((a.touchHandled = !0), h(e, "mousedown"));
    }
    function c(e) {
      a.touchHandled && h(e, "mousemove");
    }
    function g(e) {
      if (!a.touchHandled) return;
      a.pointerLeaveTimeout &&
        (window.clearTimeout(a.pointerLeaveTimeout),
        delete a.pointerLeaveTimeout);
      const t = !!n.dragElement;
      (h(e, "mouseup"), t || h(e, "click"), (a.touchHandled = !1));
    }
    function u(e) {
      "mouse" !== e.pointerType && e.target.releasePointerCapture(e.pointerId);
    }
    function p(e) {
      n.dragElement && "mouse" !== e.pointerType && l(e, "mouseenter");
    }
    function m(e) {
      n.dragElement &&
        "mouse" !== e.pointerType &&
        (a.pointerLeaveTimeout = window.setTimeout(() => {
          (delete a.pointerLeaveTimeout, l(e, "mouseleave"));
        }, 10));
    }
    class f {
      constructor(e, t, i) {
      ...
      _init() {
        if (this.option.element)
          try {
            this.el =
              this.option.element instanceof HTMLElement
                ? this.option.element
                : this.host.querySelector(this.option.element);
          } catch (e) {
            ((this.option.element = void 0),
              console.error(
                "Query for resizeable handle failed, falling back",
                e,
              ));
          }
        return (
          ...
          this.el.classList.add(`${f.prefix}${this.dir}`),
          (this.el.style.zIndex = "100"),
          (this.el.style.userSelect = "none"),
          this.el.addEventListener("mousedown", this._mouseDown),
          r &&
            (this.el.addEventListener("touchstart", d),
      ...
      destroy() {
        return (
          ...
          r &&
            (this.el.removeEventListener("touchstart", d),
            this.el.removeEventListener("pointerdown", u)),
          this.option.element || this.host.removeChild(this.el),
          delete this.el,
          delete this.host,
          this
        );
      ...
      _mouseDown(e) {
        ((this.mouseDownEvent = e),
          ...
          r &&
            (this.el.addEventListener("touchmove", c),
            this.el.addEventListener("touchend", g)),
          e.stopPropagation(),
          e.preventDefault());
      }
      _mouseMove(e) {
      ...
      _mouseUp(e) {
        (this.moving &&
          ...
          r &&
            (this.el.removeEventListener("touchmove", c),
            this.el.removeEventListener("touchend", g)),
          delete this.moving,
    ...
    class v extends _ {
      constructor(e, t = {}) {
        (super(),
          ...
          (this._ui = () => {
            ...
            return {
              position: {
                left: this.option.rtl
                  ? (e.right - i.right) * this.rectScale.x
                  : (i.left - e.left) * this.rectScale.x,
      ...
      updateOption(e) {
        const t = e.handles && e.handles !== this.option.handles,
        ...
        return (
          e
            ...
            : (this.el.classList.remove("ui-resizable-autohide"),
              ...
              n.overResizeElement === this && delete n.overResizeElement),
          this
        );
      }
      _mouseOver(e) {
        n.overResizeElement ||
          n.dragElement ||
          ((n.overResizeElement = this),
          this.el.classList.remove("ui-resizable-autohide"));
      }
      _mouseOut(e) {
        n.overResizeElement === this &&
          (delete n.overResizeElement,
          this.el.classList.add("ui-resizable-autohide"));
      }
      _setupHandlers() {
        return (
      ...
      _resizeStart(e) {
        ((this.sizeToContent = i.shouldSizeToContent(
          this.el.gridstackNode,
          !0,
        )),
      ...
      _resizing(e, t) {
        ...
        return (
          (s.resizeDir = t),
          (s.hasMovedX = this.option.rtl ? t.includes("e") : t.includes("w")),
          (s.hasMovedY = t.includes("n")),
      ...
      _getChange(e, t) {
        ...
        let r, a;
        const h = this.option.rtl;
        (!h && t.indexOf("e") > -1
          ? (s.width += o)
          : h && t.indexOf("w") > -1
            ? (s.width -= o)
            : !h && t.indexOf("w") > -1
              ? ((s.width -= o), (s.left += o), (r = !0))
              : h &&
                t.indexOf("e") > -1 &&
                ((s.width += o), (s.right += o), (r = !0)),
          t.indexOf("s") > -1
            ? (s.height += n)
            : t.indexOf("n") > -1 && ((s.height -= n), (s.top += n), (a = !0)));
        const l = this._constrainSize(s.width, s.height, r, a);
        return (
          Math.round(s.width) !== Math.round(l.width) &&
            (!h && t.indexOf("w") > -1
              ? (s.left += s.width - l.width)
              : h && t.indexOf("e") > -1 && (s.right -= s.width - l.width),
            (s.width = l.width)),
          Math.round(s.height) !== Math.round(l.height) &&
            (t.indexOf("n") > -1 && (s.top += s.height - l.height),
            (s.height = l.height)),
          s
        );
      }
      _constrainSize(e, t, i, s) {
        const o = this.option,
          ...
          a = (s ? o.maxHeightMoveUp : o.maxHeight) || Number.MAX_SAFE_INTEGER,
          h = o.minHeight / this.rectScale.y || t;
        return {
          width: Math.min(n, Math.max(r, e)),
          height: Math.min(a, Math.max(h, t)),
        };
      }
      _applyChange() {
        let e = { left: 0, right: 0, top: 0, width: 0, height: 0 };
        if ("absolute" === this.el.style.position) {
          const t = this.el.parentElement,
            { left: i, right: s, top: o } = t.getBoundingClientRect();
          e = { left: i, right: s, top: o, width: 0, height: 0 };
        }
        return this.temporalRect
          ? (Object.entries(this.temporalRect).forEach(([t, i]) => {
              if (this.option.rtl ? "left" === t : "right" === t) return;
              const s =
                "width" === t || "left" === t || "right" === t
                  ? this.rectScale.x
                  : "height" === t || "top" === t
                    ? this.rectScale.y
                    : 1;
    ...
    class y extends _ {
      constructor(e, t = {}) {
        (super(),
          ...
          (this._autoScrollTick = () => {
            const e = this.helper,
              t = this._autoScrollContainer;
            if (!e || !t) return void this._stopScrolling();
            const i = this._getClipping(e, t);
            if (0 === i) return void this._stopScrolling();
            if (!this._autoScrollMaxSpeed) {
              const e =
                window.innerHeight || document.documentElement.clientHeight;
              this._autoScrollMaxSpeed = Math.max(e / 150, 4);
            }
            const s = Math.abs(i),
              o = Math.min(0.5 * s, this._autoScrollMaxSpeed),
              n = i > 0 ? o : -o,
              r = t.scrollTop;
            ((t.scrollTop += n),
              t.scrollTop !== r
                ? (this.dragging &&
                  ...
                  (this._autoScrollAnimId = requestAnimationFrame(
                    this._autoScrollTick,
                  )))
                : this._stopScrolling());
          }));
      ...
      getAllHandles() {
        return Array.from(this.el.querySelectorAll(this.option.handle)).filter(
          (e) => {
            if (!(e instanceof HTMLElement)) return !1;
            const t = e.closest(".grid-stack-item");
            return t === this.el || !t;
          },
        );
      }
      ...
      _mouseDown(e) {
        if (
          (a.touchHandled && e.isTrusted && (a.touchHandled = !1),
          !n.mouseHandled)
        )
          return (
            0 !== e.button ||
              ...
              delete n.dragElement,
              delete n.dropElement,
              ...
              document.addEventListener("mouseup", this._mouseUp, !0),
              r &&
                (e.currentTarget.addEventListener("touchmove", c),
                e.currentTarget.addEventListener("touchend", g)),
              e.preventDefault(),
      ...
      _mouseMove(e) {
        ...
        if (((this.lastDrag = e), this.dragging))
          if ((this._dragFollow(e), n.pauseDrag)) {
            const t = Number.isInteger(n.pauseDrag) ? n.pauseDrag : 100;
            (this.dragTimeout && window.clearTimeout(this.dragTimeout),
          ...
          (t
            ? (n.dropElement = t.el.ddElement.ddDroppable)
            : delete n.dropElement,
      ...
      _mouseUp(e) {
        if (
          ...
          r &&
            e.currentTarget &&
            (e.currentTarget.removeEventListener("touchmove", c, !0),
            e.currentTarget.removeEventListener("touchend", g, !0)),
          this.dragging)
        ) {
          (delete this.dragging,
            delete this.el.gridstackNode?._origRotate,
            document.removeEventListener("keydown", this._keyEvent),
            n.dropElement?.el === this.el.parentElement && delete n.dropElement,
            (this.helperContainment.style.position =
              this.parentOriginStylePosition || null),
            this.helper !== this.el && this.helper.remove(),
            this._removeHelperStyle());
          const t = i.initEvent(e, { target: this.el, type: "dragstop" });
          (this.option.stop && this.option.stop(t),
            this.triggerEvent("dragstop", t),
            n.dropElement && n.dropElement.drop(e));
        }
        (delete this.helper,
          delete this.mouseDownEvent,
          delete n.dragElement,
          delete n.dropElement,
          delete n.mouseHandled,
          e.preventDefault());
      }
      _keyEvent(e) {
        const t = this.el.gridstackNode,
          s = t?.grid || n.dropElement?.el?.gridstack;
        if ("Escape" === e.key)
          (t &&
            t._origRotate &&
            ((t._orig = t._origRotate), delete t._origRotate),
            s?.cancelDrag(),
            this._mouseUp(this.mouseDownEvent));
        else if (t && s && ("r" === e.key || "R" === e.key)) {
      ...
      _createHelper() {
        ...
        return (
          ...
          (this.dragElementOriginStyle = y.originStyleProp.map(
            (e) => this.el.style[e],
          )),
          e
        );
      ...
      _removeHelperStyle() {
        (this.helper.classList.remove("ui-draggable-dragging"),
          this.el.gridstackNode?.grid?.el.classList.remove(
            "grid-stack-dragging",
          ));
      ...
      _dragFollow(e) {
        ...
        (this.option.rtl
          ? ((t.right =
              (window.innerWidth - e.clientX + i.offsetX) *
                this.dragTransform.xScale +
              "px"),
            t.left && (t.left = ""))
          : ((t.left =
              (e.clientX + i.offsetX) * this.dragTransform.xScale + "px"),
            t.right && (t.right = "")),
          (t.top =
            (e.clientY + i.offsetTop) * this.dragTransform.yScale + "px"));
      }
      ...
      _getDragOffset(e, t, i) {
        ...
        let r = this.option.rtl ? n.right : n.left,
          a = this.option.rtl
            ? e.clientX - n.right + s
            : -e.clientX + n.left - s;
        return {
      ...
      updateScrollPosition(e) {
        ((this._autoScrollContainer = i.getScrollElement(e)),
          0 === this._getClipping(this.helper, this._autoScrollContainer)
            ? this._stopScrolling()
            : this._autoScrollAnimId ||
              (this._autoScrollAnimId = requestAnimationFrame(
                this._autoScrollTick,
              )));
      }
      _getClipping(e, t) {
        ...
        if (i.bottom < s.top || i.top > s.bottom) return 0;
        const n = i.bottom - Math.min(s.bottom, o),
          r = i.top - Math.max(s.top, 0);
        return r < 0 ? r : n > 0 ? n : 0;
      }
      _stopScrolling() {
        this._autoScrollAnimId &&
      ...
      ui() {
        const e = this.el.parentElement.getBoundingClientRect(),
          ...
          i = this.option.rtl
            ? (e.right - t.right) * this.dragTransform.xScale
            : (t.left - e.left) * this.dragTransform.xScale;
        return {
          position: {
    ...
    class b extends _ {
      ...
      enable() {
        !1 !== this.disabled &&
          ...
          r &&
            (this.el.addEventListener("pointerenter", p),
            this.el.addEventListener("pointerleave", m)));
      }
      disable(e = !1) {
        !0 !== this.disabled &&
          (super.disable(),
          ...
          r &&
            (this.el.removeEventListener("pointerenter", p),
            this.el.removeEventListener("pointerleave", m)));
      }
      destroy() {
        (this.disable(!0),
          this.el.classList.remove("ui-droppable"),
      ...
      _mouseEnter(e) {
        ...
        if (a.touchHandled && e.isTrusted) return;
        if (!this._canDrop(n.dragElement.el)) return;
        (e.preventDefault(),
          e.stopPropagation(),
          n.dragElement._stopScrolling(),
          n.dropElement &&
            n.dropElement !== this &&
            n.dropElement._mouseLeave(e, !0),
          (n.dropElement = this));
        const t = i.initEvent(e, { target: this.el, type: "dropover" });
        (this.option.over && this.option.over(t, this._ui(n.dragElement)),
      ...
      _mouseLeave(e, t = !1) {
        ...
        (e.preventDefault(),
          e.stopPropagation(),
          t && n.dragElement._stopScrolling());
        const s = i.initEvent(e, { target: this.el, type: "dropout" });
        if (
          (this.option.out && this.option.out(s, this._ui(n.dragElement)),
          this.triggerEvent("dropout", s),
          n.dropElement === this && (delete n.dropElement, !t))
        ) {
          let t,
      ...
      drop(e) {
        ...
        (this.option.drop && this.option.drop(t, this._ui(n.dragElement)),
      ...
      setupDraggable(e) {
        return (
          this.ddDraggable
            ...
            : (this.ddDraggable = new y(this.el, e)),
          this
        );
      }
      cleanDraggable() {
      ...
      setupDroppable(e) {
        return (
          this.ddDroppable
            ...
            : (this.ddDroppable = new b(this.el, e)),
          this
        );
      }
      cleanDroppable() {
    ...
    const E = new (class {
      resizable(e, t, i, s) {
        return (
          this._getDDElements(e, t).forEach((e) => {
      ...
      dragIn(e, t) {
        return (
          this._getDDElements(e).forEach((e) => e.setupDraggable(t)),
          this
        );
      }
      droppable(e, t, i, s) {
      ...
      isDroppable(e) {
        return !(
          !e?.ddElement?.ddDroppable || e.ddElement.ddDroppable.disabled
        );
      }
      isDraggable(e) {
        return !(
          !e?.ddElement?.ddDraggable || e.ddElement.ddDraggable.disabled
        );
      }
      isResizable(e) {
        return !(
          !e?.ddElement?.ddResizable || e.ddElement.ddResizable.disabled
        );
      }
      on(e, t, i) {
        return (
          this._getDDElements(e).forEach((e) =>
            e.on(t, (e) => {
              i(
                e,
                n.dragElement ? n.dragElement.el : e.target,
                n.dragElement ? n.dragElement.helper : null,
              );
            }),
          ),
          this
      ...
      _getDDElements(e, t) {
        const s = e.gridstack || ("destroy" !== t && "disable" !== t),
          o = i.getElements(e);
        return o.length
          ? o.map((e) => e.ddElement || (s ? w.init(e) : null)).filter((e) => e)
          : [];
      }
    })();
    class x {
      static init(e = {}, t = ".grid-stack") {
        ...
        const s = x.getGridElement(t);
        return s
          ? (s.gridstack || (s.gridstack = new x(s, i.cloneDeep(e))),
            s.gridstack)
          : ("string" == typeof t
              ? console.error(
      ...
      static initAll(e = {}, t = ".grid-stack") {
        ...
        return (
          "undefined" == typeof document ||
            (x.getGridElements(t).forEach((t) => {
              (t.gridstack || (t.gridstack = new x(t, i.cloneDeep(e))),
                s.push(t.gridstack));
            }),
            0 === s.length &&
              console.error(
      ...
      static addGrid(e, t = {}) {
        ...
        return (
          (e.classList.contains("grid-stack") && !x.addRemoveCB) ||
            (s = x.addRemoveCB
              ? x.addRemoveCB(e, t, !0, !0)
              : i.createDiv(["grid-stack", t.class], e)),
          x.init(t, s)
        );
      }
      ...
      get placeholder() {
        if (!this._placeholder) {
          this._placeholder = i.createDiv([
            this.opts.placeholderClass,
            o.itemClass,
            this.opts.itemClass,
          ]);
          const e = i.createDiv(["placeholder-content"], this._placeholder);
          this.opts.placeholderText &&
            (e.textContent = this.opts.placeholderText);
        }
      ...
      constructor(e, t = {}) {
        ...
        const a = i.toNumber(e.getAttribute("gs-row"));
        ("auto" === t.column && delete t.column,
          void 0 !== t.alwaysShowResizeHandle &&
            (t._alwaysShowResizeHandle = t.alwaysShowResizeHandle));
        const h = t.columnOpts;
        if (h) {
          const e = h.breakpoints;
          h.columnWidth || e?.length
            ? ((h.columnMax = h.columnMax || 12),
              e?.length > 1 && e.sort((e, t) => (t.w || 0) - (e.w || 0)))
            : delete t.columnOpts;
        }
        const l = {
          ...i.cloneDeep(o),
          column: i.toNumber(e.getAttribute("gs-column")) || o.column,
          minRow: a || i.toNumber(e.getAttribute("gs-min-row")) || o.minRow,
          maxRow: a || i.toNumber(e.getAttribute("gs-max-row")) || o.maxRow,
          staticGrid: i.toBool(e.getAttribute("gs-static")) || o.staticGrid,
          sizeToContent:
            i.toBool(e.getAttribute("gs-size-to-content")) || void 0,
          draggable: {
            handle:
              (t.handleClass
                ? "." + t.handleClass
        ...
        (e.getAttribute("gs-animate") &&
          (l.animate = i.toBool(e.getAttribute("gs-animate"))),
          (t = i.defaults(t, l)),
          this._initMargin(),
          this.checkDynamicColumn(),
          this._updateColumnVar(t),
          "auto" === t.rtl && (t.rtl = "rtl" === e.style.direction),
          t.rtl && this.el.classList.add("grid-stack-rtl"));
        const d = this.el.closest("." + o.itemClass),
          c = d?.gridstackNode;
        if (
          (c &&
            ((c.subGrid = this),
            (this.parentGridNode = c),
            this.el.classList.add("grid-stack-nested"),
            c.el.classList.add("grid-stack-sub-grid")),
          ...
          (delete t.cellHeight, this.cellHeight(e));
        }
        ("mobile" === t.alwaysShowResizeHandle &&
          (t.alwaysShowResizeHandle = r),
          this._setStaticClass());
        const g = t.engineClass || x.engineClass || s;
        if (
          ((this.engine = new g({
        ...
        (this.setAnimation(),
          t.subGridDynamic && !n.pauseDrag && (n.pauseDrag = !0),
          void 0 !== t.draggable?.pause && (n.pauseDrag = t.draggable.pause),
          this._setupRemoveDrop(),
          this._setupAcceptWidget(),
          this._updateResizeEvent());
      }
      _updateColumnVar(e = this.opts) {
        (this.el.classList.add("gs-" + e.column),
      ...
      addWidget(e) {
        ...
        if ("string" == typeof e)
          return void console.error(
            "V11: GridStack.addWidget() does not support string anymore. see #2736",
          );
        if (e.ELEMENT_NODE)
          return (
            console.error(
              "V11: GridStack.addWidget() does not support HTMLElement anymore. use makeWidget()",
            ),
            this.makeWidget(e)
          );
        let t,
        ...
        if (
          ...
          (t = s.el
            ? s.el
            : x.addRemoveCB
              ? x.addRemoveCB(this.el, e, !0, !1)
              : this.createWidgetDivs(s)),
          !t)
        )
          return;
        if (
          ...
          s &&
            ...
            this.engine.nodes.find((e) => e._id === s._id))
        )
          return t;
        const o = this._readAttr(t);
        return (
          i.defaults(e, o),
          this.engine.prepareNode(e),
      ...
      createWidgetDivs(e) {
        const t = i.createDiv(["grid-stack-item", this.opts.itemClass]),
          s = i.createDiv(["grid-stack-item-content"], t);
        return (
          i.lazyLoad(e)
            ? e.visibleObservable ||
              ((e.visibleObservable = new IntersectionObserver(([t]) => {
                t.isIntersecting &&
                  (e.visibleObservable?.disconnect(),
                  delete e.visibleObservable,
                  x.renderCB(s, e),
                  e.grid?.prepareDragDrop(e.el));
              })),
      ...
      makeSubGrid(e, t, s, o = !0) {
        ...
        let a,
          h = this;
        for (; h && !n; )
          ((n = h.opts?.subGridOpts), (h = h.parentGridNode?.grid));
        ((t = i.cloneDeep({
          ...this.opts,
          id: void 0,
          children: void 0,
        ...
        if (
          (o &&
            ...
            x.addRemoveCB
              ? (l = x.addRemoveCB(this.el, d, !0, !1))
              : ((l = i.createDiv(["grid-stack-item"])),
                l.appendChild(c),
                (c = i.createDiv(["grid-stack-item-content"], r.el))),
            this.prepareDragDrop(r.el)),
          s)
        ) {
          const e = a ? t.column : r.w,
            i = r.h + s.h,
            o = r.el.style;
          ((o.transition = "none"),
        ...
        const g = (r.subGrid = x.addGrid(c, t));
        return (
      ...
      removeAsSubGrid(e) {
        ...
        t &&
          (t.batchUpdate(),
          t.removeWidget(this.parentGridNode.el, !0, !0),
          this.engine.nodes.forEach((e) => {
            ((e.x += this.parentGridNode.x),
              (e.y += this.parentGridNode.y),
              t.makeWidget(e.el, e));
          }),
          t.batchUpdate(!1),
          this.parentGridNode && delete this.parentGridNode.subGrid,
      ...
      save(e = !0, t = !1, s = x.saveCB, n) {
        const r = this.engine.save(e, s, n);
        if (
          (r.forEach((i) => {
            if (e && i.el && !i.subGrid && !s) {
              const e = i.el.querySelector(".grid-stack-item-content");
              ((i.content = e?.innerHTML), i.content || delete i.content);
            } else if ((e || s || delete i.content, i.subGrid?.el)) {
              const o = i.w || i.subGrid.getColumn(),
                n = i.subGrid.save(e, t, s, o);
              ((i.subGridOpts = t ? n : { children: n }), delete i.subGrid);
            }
            delete i.el;
          }),
          t)
        ) {
          const e = i.cloneDeep(this.opts);
      ...
      load(e, t = x.addRemoveCB || !0) {
        (e.forEach((e) => {
          ((e.w = e.w || e.minW || 1), (e.h = e.h || e.minH || 1));
        }),
          (e = i.sort(e)),
          (this.engine.skipCacheUpdate = this._ignoreLayoutsNodeChange = !0));
        let s = 0;
        (e.forEach((e) => {
          s = Math.max(s, (e.x || 0) + e.w);
        }),
          s > this.engine.defaultColumn && (this.engine.defaultColumn = s));
        const o = this.getColumn();
        s > o &&
          (0 === this.engine.nodes.length && this.responseLayout
            ? ((this.engine.nodes = e),
              this.engine.columnChanged(s, o, this.responseLayout),
              (e = this.engine.nodes),
              (this.engine.nodes = []),
              delete this.responseLayout)
            : this.engine.cacheLayout(e, s, !0));
        const n = x.addRemoveCB;
        "function" == typeof t && (x.addRemoveCB = t);
        const r = [];
        this.batchUpdate();
        const a = !this.engine.nodes.length,
          h = a && this.opts.animate;
        (h && this.setAnimation(!1),
          !a &&
            ...
            [...this.engine.nodes].forEach((t) => {
              t.id &&
                (i.find(e, t.id) ||
                  (x.addRemoveCB && x.addRemoveCB(this.el, t, !1, !1),
                  r.push(t),
        ...
        return (
          (this.engine.nodes = this.engine.nodes.filter(
            (t) => !i.find(e, t.id) || (l.push(t), !1),
          )),
          e.forEach((e) => {
            const s = i.find(l, e.id);
            if (s) {
              if (
                ...
                i.samePos(s, e) &&
                  this.engine.nodes.length > 1 &&
                  (this.moveNode(s, { ...e, forceCollide: !0 }),
                  i.copyPos(e, s)),
                this.update(s.el, e),
                e.subGridOpts?.children)
              ) {
                const t = s.el.querySelector(".grid-stack");
          ...
          n ? (x.addRemoveCB = n) : delete x.addRemoveCB,
          h && this.setAnimation(!0, !0),
          this
        );
      }
      batchUpdate(e = !0) {
      ...
      getCellHeight(e = !1) {
        ...
        if (t) {
          const e = i.toNumber(t.getAttribute("gs-h")) || 1;
          return Math.round(t.offsetHeight / e);
        }
        const s = parseInt(this.el.getAttribute("gs-current-row"));
        return s
      ...
      cellHeight(e) {
        ...
        const t = i.parseHeight(e);
        return (
          (this.opts.cellHeightUnit === t.unit &&
            this.opts.cellHeight === t.h) ||
            ((this.opts.cellHeightUnit = t.unit),
            (this.opts.cellHeight = t.h),
            this.el.style.setProperty(
              "--gs-cell-height",
        ...
        if (this.el)
          return (
            ...
            e
              ...
              : (this.removeAll(e), this.el.removeAttribute("gs-current-row")),
            this.parentGridNode && delete this.parentGridNode.subGrid,
            delete this.parentGridNode,
            delete this.opts,
      ...
      getCellFromPixel(e, t = !1) {
        ...
        let s;
        s = t
          ? { top: i.top + document.documentElement.scrollTop, left: i.left }
          : { top: this.el.offsetTop, left: this.el.offsetLeft };
        const o = e.left - s.left,
          n = e.top - s.top,
          r = i.width / this.getColumn(),
          a = i.height / parseInt(this.el.getAttribute("gs-current-row"));
        return { x: Math.floor(o / r), y: Math.floor(n / a) };
      }
      getRow() {
      ...
      makeWidget(e, t) {
        const i = x.getElement(e);
        if (!i || i.gridstackNode) return i;
        (i.parentElement || this.el.appendChild(i),
        ...
        return (
          ...
          1 !== this.opts.column ||
            ...
            (o = this._ignoreLayoutsNodeChange = !0),
          this._triggerAddEvent(),
          this._triggerChangeEvent(),
          o && delete this._ignoreLayoutsNodeChange,
          i
        );
      }
      on(e, t) {
        ...
        if (
          ...
          const i = "enable" === e || "disable" === e;
          ((this._gsEventHandler[e] = i
            ? (e) => t(e)
            : (e) => {
                e.detail && t(e, e.detail);
              }),
      ...
      removeAll(e = !0, t = !0) {
        return (
          this.engine.nodes.forEach((t) => {
            (e && x.addRemoveCB && x.addRemoveCB(this.el, t, !1, !1),
      ...
      updateOptions(e) {
        ...
        if (e === t) return this;
        if (
          (void 0 !== e.acceptWidgets &&
            ((t.acceptWidgets = e.acceptWidgets), this._setupAcceptWidget()),
          void 0 !== e.animate && this.setAnimation(e.animate),
          e.cellHeight && this.cellHeight(e.cellHeight),
          void 0 !== e.class &&
            e.class !== t.class &&
            (t.class && this.el.classList.remove(t.class),
            e.class && this.el.classList.add(e.class)),
          e.columnOpts)
        ) {
          const t = !!this.opts.columnOpts;
          ((this.opts.columnOpts = e.columnOpts),
            t !== !!this.opts.columnOpts && this._updateResizeEvent(),
            this.checkDynamicColumn());
        } else
          null === e.columnOpts && this.opts.columnOpts
            ? (delete this.opts.columnOpts, this._updateResizeEvent())
            : "number" == typeof e.column && this.column(e.column);
        return (
          void 0 !== e.margin && this.margin(e.margin),
          void 0 !== e.staticGrid && this.setStatic(e.staticGrid),
          void 0 === e.disableDrag ||
            e.staticGrid ||
            this.enableMove(!e.disableDrag),
          void 0 === e.disableResize ||
            e.staticGrid ||
            this.enableResize(!e.disableResize),
          void 0 !== e.float && this.float(e.float),
          void 0 !== e.row
            ? ((t.minRow = t.maxRow = t.row = e.row),
              this._updateContainerHeight())
            : (void 0 !== e.minRow &&
                ((t.minRow = e.minRow), this._updateContainerHeight()),
              void 0 !== e.maxRow &&
                (t.maxRow = this.engine.maxRow = e.maxRow)),
          void 0 !== e.lazyLoad && (t.lazyLoad = e.lazyLoad),
          e.children?.length && this.load(e.children),
          this
        );
      }
      update(e, t) {
        return (
          x.getElements(e).forEach((e) => {
            ...
            if (!s) return;
            const o = { ...i.copyPos({}, s), ...i.cloneDeep(t) };
            (this.engine.nodeBoundFix(o), delete o.autoPosition);
            const n = ["x", "y", "w", "h"];
            let r;
            if (
              (n.some((e) => void 0 !== o[e] && o[e] !== s[e]) &&
                ((r = {}),
                n.forEach((e) => {
                  ((r[e] = void 0 !== o[e] ? o[e] : s[e]), delete o[e]);
                })),
              !r && (o.minW || o.minH || o.maxW || o.maxH) && (r = {}),
              void 0 !== o.content)
            ) {
              const t = e.querySelector(".grid-stack-item-content");
              (t &&
                t.textContent !== o.content &&
                ((s.content = o.content),
                x.renderCB(t, o),
                s.subGrid?.el &&
                  (t.appendChild(s.subGrid.el),
                  s.subGrid._updateContainerHeight())),
                delete o.content);
            }
            let a = !1,
              h = !1;
            ...
            if ((i.sanitizeMinMax(s), r)) {
              const e = void 0 !== r.w && r.w !== s.w;
              (this.moveNode(s, r),
                e && s.subGrid
                  ? s.subGrid.onResize(this.hasAnimationCSS() ? s.w : void 0)
                  : this.resizeToContentCheck(e, s),
                delete s._orig);
            }
            ((r || a) && this._writeAttr(e, s),
              h && this.prepareDragDrop(s.el),
              x.updateCB && x.updateCB(s));
          }),
          this
        );
      }
      ...
      resizeToContent(e) {
        ...
        if (
          ...
          o || (o = e.querySelector(x.resizeToContentParent)),
          !o)
        )
          return;
        const r = e.clientHeight - o.clientHeight,
          a = t.h ? t.h * s - r : o.clientHeight;
        let h;
        if (t.subGrid) {
          h = t.subGrid.getRow() * t.subGrid.getCellHeight(!0);
          const i = t.subGrid.el.getBoundingClientRect(),
          ...
          if (t.subGridOpts?.children?.length) return;
          {
            ...
            if (!e)
              return void console.error(
                `Error: GridStack.resizeToContent() widget id:${t.id} '${x.resizeToContentParent}'.firstElementChild is null, make sure to have a div like container. Skipping sizing.`,
              );
            h = e.getBoundingClientRect().height || a;
          }
        }
        if (a === h) return;
        n += h - a;
        ...
        (d && l > d && ((l = d), e.classList.add("size-to-content-max")),
          t.minH && l < t.minH
            ? (l = t.minH)
            : t.maxH && l > t.maxH && (l = t.maxH),
          l !== t.h &&
      ...
      resizeToContentCBCheck(e) {
        x.resizeToContentCB ? x.resizeToContentCB(e) : this.resizeToContent(e);
      }
      rotate(e, t) {
        return (
          x.getElements(e).forEach((e) => {
            ...
            if (t) {
              const e = t.left > 0 ? Math.floor(t.left / this.cellWidth()) : 0,
      ...
      _updateContainerHeight() {
        ...
        return (
          ...
          e && i.shouldSizeToContent(e) && e.grid.resizeToContentCBCheck(e.el),
          this
        );
      }
      _prepareElement(e, t = !1, s) {
        ...
        return (
          ...
          i.lazyLoad(s) || this.prepareDragDrop(s.el),
          this
        );
      }
      _writePosAttr(e, t) {
        if ((!t._moving && !t._resizing) || this._placeholder === e) {
          const i = this.opts.rtl ? "right" : "left";
          ((e.style.top = t.y
            ? 1 === t.y
              ? "var(--gs-cell-height)"
              : `calc(${t.y} * var(--gs-cell-height))`
            : null),
            (e.style[i] = t.x
              ? 1 === t.x
                ? "var(--gs-column-width)"
                : `calc(${t.x} * var(--gs-column-width))`
              : null),
            (e.style.width =
              t.w > 1 ? `calc(${t.w} * var(--gs-column-width))` : null),
            (e.style.height =
              t.h > 1 ? `calc(${t.h} * var(--gs-cell-height))` : null));
        }
        return (
      ...
      _readAttr(e, t = !0) {
        ...
        const o = e.getAttribute("gs-size-to-content");
        (o &&
          (s.sizeToContent =
            "true" === o || "false" === o ? i.toBool(o) : parseInt(o, 10)),
        ...
        for (const e in s) {
          ...
          s[e] || 0 === s[e] || "sizeToContent" === e || delete s[e];
        }
        return s;
      }
      _setStaticClass() {
      ...
      onResize(e = this.el?.clientWidth) {
        ...
        let t = !1;
        return (
          this._autoColumn && this.parentGridNode
            ? this.opts.column !== this.parentGridNode.w &&
              (this.column(this.parentGridNode.w, this.opts.layout || "list"),
              (t = !0))
            : (t = this.checkDynamicColumn()),
          this._isAutoCellHeight && this.cellHeight(),
          this.engine.nodes.forEach((e) => {
            e.subGrid && e.subGrid.onResize();
          }),
          this._skipInitialResize || this.resizeToContentCheck(t),
        ...
        if (this.engine) {
          ...
          if (t) i.shouldSizeToContent(t) && this.resizeToContentCBCheck(t.el);
            ...
            (this.batchUpdate(),
              ...
              (this._ignoreLayoutsNodeChange = !0),
              this.batchUpdate(!1),
              (this._ignoreLayoutsNodeChange = !1));
          }
      ...
      static setupDragIn(e, t, s, o = document) {
        (void 0 !== t?.pause && (n.pauseDrag = t.pause),
          (t = { appendTo: "body", helper: "clone", ...(t || {}) }),
          ("string" == typeof e ? i.getElements(e, o) : e).forEach((e, i) => {
            (E.isDraggable(e) || E.dragIn(e, t),
              s?.[i] && (e.gridstackNode = s[i]));
          }));
      }
      movable(e, t) {
        return (
      ...
      cancelDrag() {
        ...
        e &&
          (e._isExternal
            ? ((e._isAboutToRemove = !0), this.engine.removeNode(e))
            : e._isAboutToRemove && x._itemRemoving(e.el, !1),
          this.engine.restoreInitial());
      }
      _removeDD(e) {
        return (
          E.draggable(e, "destroy").resizable(e, "destroy"),
      ...
      _setupAcceptWidget() {
        ...
        const s = (s, o, n) => {
          ...
          let { top: a, left: h } = n.getBoundingClientRect();
        ...
        return (
          E.droppable(this.el, {
            accept: (e) => {
              const t = e.gridstackNode || this._readAttr(e, !1);
              ...
              if (i && t && this.opts.maxRow) {
                const e = { w: t.w, h: t.h, minW: t.minW, minH: t.minH };
            ...
            .on(this.el, "dropover", (i, o, n) => {
              let r = n?.gridstackNode || o.gridstackNode;
              if (r?.grid === this && !r._temporaryRemoved) return !1;
              if (
                (r?._sidebarOrig &&
                  ((r.w = r._sidebarOrig.w), (r.h = r._sidebarOrig.h)),
                r?.grid &&
                  r.grid !== this &&
                  !r._temporaryRemoved &&
                  r.grid._leave(o, n),
                ...
                const e =
                  n.getAttribute("data-gs-widget") ||
                  n.getAttribute("gridstacknode");
                if (e) {
                  try {
                    r = JSON.parse(e);
                  } catch (t) {
                    console.error("Gridstack dropover: Bad JSON format: ", e);
                  }
                  (n.removeAttribute("data-gs-widget"),
                    n.removeAttribute("gridstacknode"));
                }
                (r || (r = this._readAttr(n)),
                  (r._sidebarOrig = { w: r.w, h: r.h }));
              }
              r.grid ||
                (r.el || (r = { ...r }),
                (r._isExternal = !0),
                (n.gridstackNode = r));
              const a = r.w || Math.round(n.offsetWidth / t) || 1,
                h = r.h || Math.round(n.offsetHeight / e) || 1;
              return (
                r.grid && r.grid !== this
                  ? (o._gridstackNodeOrig || (o._gridstackNodeOrig = r),
                    (o.gridstackNode = r = { ...r, w: a, h, grid: this }),
                    delete r.x,
                    delete r.y,
                    this.engine.cleanupNode(r).nodeBoundFix(r),
                    (r._initDD = r._isExternal = r._temporaryRemoved = !0))
                  : ((r.w = a), (r.h = h), (r._temporaryRemoved = !0)),
                x._itemRemoving(r.el, !1),
                E.on(o, "drag", s),
                s(i, o, n),
                !1
              );
            ...
            .on(this.el, "dropout", (e, t, i) => {
              const s = i?.gridstackNode || t.gridstackNode;
              return (
                !!s &&
                ((s.grid && s.grid !== this) ||
            ...
            .on(this.el, "drop", (e, t, s) => {
              const o = s?.gridstackNode || t.gridstackNode;
              ...
              (this.placeholder.remove(),
                ...
                n &&
                  this.opts.animate &&
                  (this.setAnimation(!1), this.setAnimation(!0, !0)));
              const a = t._gridstackNodeOrig;
              if (
                (delete t._gridstackNodeOrig, n && a?.grid && a.grid !== this)
              ) {
                const e = a.grid;
                (e.engine.removeNodeFromLayoutCache(a),
                  e.engine.removedNodes.push(a),
              ...
              if (
                ...
                E.off(t, "drag"),
                s !== t ? (s.remove(), (t = s)) : t.remove(),
                this._removeDD(t),
                !n)
              )
                return !1;
              const h = o.subGrid?.el?.gridstack;
              return (
                i.copyPos(o, this._readAttr(this.placeholder)),
                i.removePositioningStyles(t),
                r && (o.content || o.subGridOpts || x.addRemoveCB)
                  ? (delete o.el, (t = this.addWidget(o)))
                  : (this._prepareElement(t, !0, o),
                    this.el.appendChild(t),
                    this.resizeToContentCheck(!1, o),
                    h && (h.parentGridNode = o),
                    this._updateContainerHeight()),
      ...
      _setupRemoveDrop() {
        ...
        return e
          ? (this.opts.staticGrid ||
              E.isDroppable(e) ||
              E.droppable(e, this.opts.removableOptions)
                .on(e, "dropover", (e, t) => x._itemRemoving(t, !0))
                .on(e, "dropout", (e, t) => x._itemRemoving(t, !1)),
            this)
          : this;
      }
      prepareDragDrop(e, t = !1) {
        const s = e?.gridstackNode;
        if (!s) return;
        const o = s.noMove || this.opts.disableDrag,
          n = s.noResize || this.opts.disableResize,
          r = this.opts.staticGrid || (o && n);
        if ((t || r) && (s._initDD && (this._removeDD(e), delete s._initDD), r))
          return (
        ...
        if (!s._initDD) {
          let t, o;
          const n = (i, n) => {
              (this.triggerEvent(i, i.target),
                (t = this.cellWidth()),
                (o = this.getCellHeight(!0)),
                this._onStartMoving(e, i, n, s, t, o));
            },
            r = (i, n) => {
              this._dragOrResize(e, i, n, s, t, o);
            },
            a = (t) => {
              (this.placeholder.remove(),
                delete this.placeholder.gridstackNode,
                ...
                delete s._event,
                delete s._lastTried);
              const o = s.w !== s._orig.w,
                n = t.target;
              if (n.gridstackNode && n.gridstackNode.grid === this) {
                if (((s.el = n), s._isAboutToRemove)) {
                  const i = e.gridstackNode.grid;
                  (i._gsEventHandler[t.type] && i._gsEventHandler[t.type](t, n),
                    i.engine.nodes.push(s),
                    i.removeWidget(e, !0, !0));
                } else
                  (i.removePositioningStyles(n),
                    s._temporaryRemoved
                      ? (this._writePosAttr(n, s), this.engine.addNode(s))
                      : this._writePosAttr(n, s),
                ...
                ((this._extraDragRow = 0),
                  ...
                  this.engine.endUpdate(),
                  "resizestop" === t.type &&
                    (Number.isInteger(s.sizeToContent) &&
                      (s.sizeToContent = s.h),
                    this.resizeToContentCheck(o, s)));
              }
            };
          (E.draggable(e, {
            start: n,
            ...
            drag: r,
            rtl: this.opts.rtl,
          }).resizable(e, { start: n, stop: a, resize: r, rtl: this.opts.rtl }),
            (s._initDD = !0));
        }
        return (
          E.draggable(e, o ? "disable" : "enable").resizable(
            e,
            n ? "disable" : "enable",
          ),
          this
      ...
      _onStartMoving(e, t, s, o, n, r) {
        ...
        if (
          ...
          (o._resizing = "resizestart" === t.type),
          delete o._lastTried,
          "dropover" === t.type &&
            o._temporaryRemoved &&
          ...
          E.resizable(e, "option", "minWidth", n * Math.min(o.minW || 1, t))
      ...
      _dragOrResize(e, t, s, o, r, a) {
        const h = { ...o._orig };
        let l,
          d = this.opts.marginLeft,
          c = this.opts.marginRight,
          g = this.opts.marginTop,
          u = this.opts.marginBottom;
        const p = Math.round(0.1 * a),
          m = Math.round(0.1 * r);
        if (
          ((d = Math.min(d, m)),
          (c = Math.min(c, m)),
          ...
          ((o._prevYPix = s.position.top),
            !1 !== this.opts.draggable.scroll &&
              n.dragElement?.updateScrollPosition(this.el));
          const e =
              s.position.left +
              (s.position.left > o._lastUiPosition.left ? -c : d),
            t =
              s.position.top +
              (s.position.top > o._lastUiPosition.top ? -u : g);
          ((h.x = Math.round(e / r)), (h.y = Math.round(t / a)));
          const i = this._extraDragRow;
          if (this.engine.collide(o, h)) {
            const e = this.getRow();
            let t = Math.max(0, h.y + o.h - e);
            (this.opts.maxRow &&
          ...
          if (
            (this._extraDragRow !== i && this._updateContainerHeight(),
            o.x === h.x && o.y === h.y)
          )
            return;
          ...
          if (h.x < 0) return;
          if (
            (i.updateScrollResize(t, e, a),
            (h.w = Math.round((s.size.width - d) / r)),
            (h.h = Math.round((s.size.height - g) / a)),
            o.w === h.w && o.h === h.h)
          )
            return;
          if (o._lastTried && o._lastTried.w === h.w && o._lastTried.h === h.h)
            return;
          if (t.hasMovedX) {
            const e = s.position.left + d;
            h.x = Math.round(e / r);
          }
          if (t.hasMovedY) {
            const e = s.position.top + g;
            h.y = Math.round(e / a);
          }
          l = !0;
        }
        ...
        const f = {
          x: s.position.left + d,
          y: s.position.top + g,
          w: (s.size ? s.size.width : o.w * r) - d - c,
          h: (s.size ? s.size.height : o.h * a) - g - u,
        };
        if (
          ...
          ((o._lastUiPosition = s.position),
            this.engine.cacheRects(r, a, g, c, u, d),
            delete o._skipDown,
            l && o.subGrid && o.subGrid.onResize(),
            (this._extraDragRow = 0),
            this._updateContainerHeight());
          const e = t.target;
          (o._sidebarOrig || this._writePosAttr(e, o), this.triggerEvent(t, e));
        }
      }
      triggerEvent(e, t) {
        let i = this;
      ...
      _leave(e, t) {
        const i = (t = t || e).gridstackNode;
        if (!i) return;
        if (
          ((t.style.transform = t.style.transformOrigin = null),
          E.off(e, "drag"),
          i._temporaryRemoved)
        )
          return;
        ...
        (i._isExternal && this.engine.cleanupNode(i),
          (i._sidebarOrig = s),
          !0 === this.opts.removable && x._itemRemoving(e, !0),
          e._gridstackNodeOrig
            ? ((e.gridstackNode = e._gridstackNodeOrig),
              delete e._gridstackNodeOrig)
            : i._isExternal && this.engine.restoreInitial());
      }
    }
    return (
      (x.renderCB = (e, t) => {
      ...
      (x.resizeToContentParent = ".grid-stack-item-content"),
      (x.Utils = i),
      (x.Engine = s),
      (x.GDRev = "12.6.0"),
      t.GridStack
